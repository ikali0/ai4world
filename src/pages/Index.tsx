...
const Index: React.FC = () => {
  ...
  if (currentView === "methodology") {
    return <MethodologyPage onBack={() => setCurrentView("home")} />;
  }
      ...
      <nav className="relative z-20 pt-4 pb-3 px-4 sm:pt-6 sm:pb-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2 sm:gap-3 cursor-pointer" onClick={() => navigate("home")}>
            ...
            <div>
              <div className="text-foreground font-semibold text-xs sm:text-sm tracking-wide">
          ...
          <div className="hidden md:flex items-center gap-6">
            <button
              ...
              className="text-xs transition-colors uppercase tracking-widest text-accent-foreground hover:text-primary"
            >
              Sectors
            </button>
            <button
            ...
            <SheetContent side="right" className="w-72 bg-card border-border">
              ...
              <div className="flex flex-col gap-6 mt-8">
                ...
                <button
                  ...
                  className="text-left text-sm font-medium text-foreground hover:text-primary transition-colors py-2 border-b border-border/30"
                >
                  Home
                </button>
                ...
                <div className="space-y-1">
                  ...
                  <button
                    onClick={() => scrollToSection("sectors")}
                    className="block w-full text-left text-sm text-foreground hover:text-primary transition-colors py-1.5"
                  >
                    Sectors
                  </button>
                  <button
